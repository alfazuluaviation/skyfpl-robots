...
ENRC_BBOXES = {
    ...
    "4": (-50.0, -4.0, -23.0, 13.0),   # Nordeste Oceânico (Mar sob a L3)
    "6": (-67.0, -20.0, -41.0, 6.0),   # Centro/Norte Interior
    "5": (-69.0, -31.0, -45.0, -9.0),  # Centro-Oeste Sul
    "3": (-50.0, -18.0, -33.0, 5.0),   # Nordeste Litoral (Sobrepõe o Mar L4)
    "1": (-62.0, -40.0, -40.0, -20.0), # Sul Expandido
    "2": (-55.0, -28.0, -32.0, -8.0),  # Centro-Oeste/Sudeste SP/RJ/BSB (Topo Absoluto)
}
                    ...
                    with mbtiles_lock:
                        if existing_conn:
                            ...
                            if row:
                                ...
                                # 🛡️ PROTEÇÃO DE RIQUEZA (Anti-Borda-Branca):
                                # Se o tile existente no banco for 3x ou mais denso que o novo tile,
                                # o novo é provavelmente apenas uma borda marginal branca/opaca da carta vizinha.
                                # Preservamos o conteúdo mais rico sem compor por cima.
                                # Exemplo: existente=35KB, novo=5KB → razão=7x → PULA (protege Três Marias)
                                # Exemplo: existente=20KB, novo=12KB → razão=1.6x → COMPOSTA (conteúdo legítimo)
